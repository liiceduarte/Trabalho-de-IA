...
public class Dijkstra : MonoBehaviour, IPathFinder{
    public WayPointGrid mapGrid;
    List<Node> visiteds;
    List<Node> prepared;
                    ...
                    if(mapGrid.Edges[node.index, i]){
                        ...
                        if (!IsVisited(i))
                        {
                            ...
                            if (noPreparado is null)
                            {
                                ...
                                noPreparado.weight = node.weight + mapGrid.GetWeight(node.index, i);
                                noPreparado.index = i;
                                noPreparado.travelLength = noPreparado.weight;
                            ...
                            else
                            {
                                ...
                                if (node.weight + mapGrid.GetWeight(node.index, i) < noPreparado.weight)
                                {
